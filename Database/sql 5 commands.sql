...
select
StudentId, Fname as FirstName, S.StudentId as Stu_StudentId, C.StudentId as Com_StudentId, Model
from Student S inner join Computer C on S.StudentId = C.StudentId;
